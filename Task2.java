...
public class Task2 implements Comparator {
    ...
    public static void main(String[] args) {
        String[] alphaNumericStringArray
                = new String[]{"ABC100", "Py14-1", "Py130-1a", "ABC3", "Py14-12", "ABC30", "Py14-2", "ABC1"};
        Arrays.sort(alphaNumericStringArray, new Task2());
